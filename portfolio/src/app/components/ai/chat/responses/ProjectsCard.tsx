...
const PROJECTS = [
  {
    name: "ACTUS",
    description: "Accounting validation platform with 284+ rules engine",
  ...
  },
  {
    ...
    description: "RAG-powered accounting rule generation system",
    image: "/icons/skills/ai-svgrepo-com.svg",
    tags: ["Gemini", "ChromaDB", "RAG"],
    link: "/projects/ai-rule-generator",
  },
  {
    name: "Eco-Carona",
    description: "Full-stack carpooling platform with Go and Next.js",
    image: "/icons/skills/golang-svgrepo-com.svg",
    tags: ["Go", "Next.js", "Docker"],
    link: "/projects/eco-carona",
  },
  {
    name: "MySell",
    description: "Sales dashboard for small entrepreneurs",
    image: "/icons/skills/spring-svgrepo-com.svg",
  ...
  },
  {
    ...
    image: "/icons/skills/arduino-svgrepo-com.svg",
